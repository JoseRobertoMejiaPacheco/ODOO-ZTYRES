# -*- coding: utf-8 -*-
{
    ...
    'summary': """
        ...
        de Odoo, en una página autenticada y en una API externa con key.""",
...
deshabilitada.
    ...
    #   2) ztyres_promotions.assets_cotizador_public: página autenticada
    #      (con sesión de Odoo), montada a mano (public_main.js) sobre el
