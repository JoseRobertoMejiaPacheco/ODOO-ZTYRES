...
class VentasPorVendedorIndividual(models.TransientModel):
    _name = 'ventas_por_vendedor_individual'

    def get_report(self, vendedor_id):
        ...
        self.env.cr.execute(query, (primer_dia_mes, ultimo_dia_mes, vendedor_id))
...
###########################################################################################################################################
        ...
        """
        ##Retornar la consulta sql
        self.env.cr.execute(query10, (primer_dia_mes, ultimo_dia_mes, vendedor_id))
        ...
        search_domain20 = [
            ...
            ('move_id.invoice_user_id', '=', vendedor_id),
