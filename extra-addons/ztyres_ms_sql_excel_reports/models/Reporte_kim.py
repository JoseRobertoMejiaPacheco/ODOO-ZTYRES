...
query3 = """
    ...
    AND apr.max_date >= '2000-12-30' AND apr.max_date <= '2024-12-30'
    GROUP BY am2."name", rpu."name", apr.max_date, am.currency_id, am.date, am.move_type
"""
# Ejecutar la consulta y crear el DataFrame
...
merged_df2['dias de atraso'] = (pd.to_datetime('2024-12-30') - pd.to_datetime(merged_df2['fecha_limite'])).dt.days
...
merged_df3.to_excel('/mnt/extra-addons/Reporte Kim 05.xlsx') 