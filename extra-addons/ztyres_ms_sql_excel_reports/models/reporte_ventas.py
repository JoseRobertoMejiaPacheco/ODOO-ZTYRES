...
class ReporteVentas(models.TransientModel):
    ...
    def get_report(self):
        ...
        # primer_dia_mes = pd.to_datetime('2025-02-01')
        # ultimo_dia_mes = pd.to_datetime('2025-02-28')
        ...
        query = """
            ...
            AND ru.id NOT IN (31, 78, 54, 89, 43)
        ...
        query3 = """
            ...
            """
        ##Retornar la consulta sql
        self.env.cr.execute(query3, (primer_dia_mes, ultimo_dia_mes))
